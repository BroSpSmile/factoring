...
public interface ProjectItemDao {
     ...
     * @return
     */
    @Insert("insert project_item (project_id,item_kind,item_type,item_name,item_value,attach_type) values(#{projectId},#{itemKind},#{itemType},#{itemName},#{itemValue},#{attachType})")
