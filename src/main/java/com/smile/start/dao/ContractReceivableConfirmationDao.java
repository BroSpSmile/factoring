...
public interface ContractReceivableConfirmationDao {
     ...
     * @return
     */
    @Insert("insert into contract_receivable_confirmation (serial_no,contract_serial_no,confirmation_code,assignor,sign_date,obligor,business_contract_name,unpaid_receivable_assignee_money,unpaid_receivable_assignee_money_upper,receivable_assignee_money,receivable_assignee_money_upper,receivable_recovery_money,receivable_recovery_money_upper,receivable_expiry_date,contract_receivable,contract_receivable_upper,assignor_abligor_receivable,assignor_abligor_receivable_upper,unpaid_assignor_abligor_receivable,unpaid_assignor_abligor_receivable_upper,receivable_assignee_money_paid,receivable_assignee_money_paid_upper,assignor_commit_date,assignee_account_name,assignee_bank_name,assignee_account,confirmation_address,assignee_signature_date,assignor_company_name,assignor_signature_date,obligor_company_name,obligor_signature_date,name_of_subject,invoice_money) values (#{serialNo},#{contractSerialNo},#{confirmationCode},#{assignor},#{signDate},#{obligor},#{businessContractName},#{unpaidReceivableAssigneeMoney},#{unpaidReceivableAssigneeMoneyUpper},#{receivableAssigneeMoney},#{receivableAssigneeMoneyUpper},#{receivableRecoveryMoney},#{receivableRecoveryMoneyUpper},#{receivableExpiryDate},#{contractReceivable},#{contractReceivableUpper},#{assignorAbligorReceivable},#{assignorAbligorReceivableUpper},#{unpaidAssignorAbligorReceivable},#{unpaidAssignorAbligorReceivableUpper},#{receivableAssigneeMoneyPaid},#{receivableAssigneeMoneyPaidUpper},#{assignorCommitDate},#{assigneeAccountName},#{assigneeBankName},#{assigneeAccount},#{confirmationAddress},#{assigneeSignatureDate},#{assignorCompanyName},#{assignorSignatureDate},#{obligorCompanyName},#{obligorSignatureDate},#{nameOfSubject},#{invoiceMoney})")
