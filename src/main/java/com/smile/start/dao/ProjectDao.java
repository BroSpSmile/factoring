...
public interface ProjectDao {
    ...
    @Results(id = "queryFactoringProjectMap", value = { @Result(id = true, column = "id", property = "id"), @Result(column = "person", property = "user.id"),
                                                        ...
                                                        @Result(column = "remittance_day", property = "detail.remittanceDay"),@Result(column = "total_factoring_fee", property = "detail.totalFactoringFee"),
                                                        @Result(column = "return_rate", property = "detail.returnRate"),@Result(column = "loan_audit_pass_time", property = "detail.loanAuditPassTime") })
