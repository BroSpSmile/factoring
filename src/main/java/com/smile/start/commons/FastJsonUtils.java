 ...
 * 
 * @author smile.jing
 * @version $Id: FastJsonUtils.java, v 0.1 Jan 13, 2019 8:54:00 PM smile.jing
 *          Exp $
 */
public class FastJsonUtils {
	...
	/** 反序列化属性 */
	private static final Feature[] deSerializerFeatures = { Feature.AllowUnQuotedFieldNames, Feature.AllowSingleQuotes,
			Feature.InternFieldNames, Feature.AllowArbitraryCommas, Feature.IgnoreNotMatch };
