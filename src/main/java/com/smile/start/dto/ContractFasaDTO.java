 ...
 * 财务顾问服务协议
 * @author Joseph
 * @version v1.0 2019/3/23 15:16, ContractFasaDTO.java
 * @since 1.8
 */
public class ContractFasaDTO implements Serializable {
    private static final long serialVersionUID = 7084641728461504988L;
