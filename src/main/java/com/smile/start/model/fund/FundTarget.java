...
public class FundTarget implements Serializable {
    ...
    public String toString() {
        return "{\"" + (id != null ? "id\":\"" + id + "\", \"" : "") + (projectId != null ? "projectId\":\"" + projectId + "\", \"" : "")
               + (projectName != null ? "projectName\":\"" + projectName + "\", \"" : "") + (projectStep != null ? "projectStep\":\"" + projectStep + "\", \"" : "")
               + (industry != null ? "industry\":\"" + industry + "\", \"" : "") + (location != null ? "location\":\"" + location + "\", \"" : "")
               + (mainBusiness != null ? "mainBusiness\":\"" + mainBusiness + "\", \"" : "") + (memberA != null ? "memberA\":\"" + memberA + "\", \"" : "")
               + (memberB != null ? "memberB\":\"" + memberB + "\", \"" : "") + (investment != null ? "investment\":\"" + investment + "\", \"" : "")
               + (investmentPart != null ? "investmentPart\":\"" + investmentPart + "\", \"" : "")
               + (shareHodingRate != null ? "shareHodingRate\":\"" + shareHodingRate + "\", \"" : "") + (preVal != null ? "preVal\":\"" + preVal + "\", \"" : "")
               + (postVal != null ? "postVal\":\"" + postVal + "\", \"" : "") + (investemntTime != null ? "investemntTime\":\"" + investemntTime + "\", \"" : "")
               ...
               + (registeredCapital != null ? "registeredCapital\":\"" + registeredCapital + "\", \"" : "") + (chairman != null ? "chairman\":\"" + chairman + "\", \"" : "")
               + (address != null ? "address\":\"" + address + "\", \"" : "") + (projectChannel != null ? "projectChannel\":\"" + projectChannel + "\", \"" : "")
               + (createTime != null ? "createTime\":\"" + createTime + "\", \"" : "") + (operator != null ? "operator\":\"" + operator : "") + "\"}  ";
    }
