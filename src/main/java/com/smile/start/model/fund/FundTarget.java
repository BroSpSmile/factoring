...
public class FundTarget implements Serializable {
    ...
    public String toString() {
        return "{\"FundTarget\":{" + "\"id\":" + id + ",\"projectStep\":" + projectStep + ",\"industry\":\"" + industry + '\"' + ",\"location\":\"" + location + '\"'
               + ",\"mainBusiness\":\"" + mainBusiness + '\"' + ",\"memberA\":" + memberA + ",\"memberB\":" + memberB + ",\"investment\":" + investment + ",\"investmentPart\":\""
               + investmentPart + '\"' + ",\"shareHodingRate\":\"" + shareHodingRate + '\"' + ",\"preVal\":" + preVal + ",\"postVal\":" + postVal + ",\"investemntTime\":\""
               + investemntTime + '\"' + ",\"companySortName\":\"" + companySortName + '\"' + ",\"companyFullName\":\"" + companyFullName + '\"' + ",\"controllerOwner\":\""
               + controllerOwner + '\"' + ",\"registeredCapital\":" + registeredCapital + ",\"chairman\":\"" + chairman + '\"' + ",\"address\":\"" + address + '\"'
